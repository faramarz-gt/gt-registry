        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Complete navigation header with GTreasury branding, featuring logo
              placement, 8 treasury-focused navigation items, search
          ...
          <section>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Clickable logo that serves as home navigation with
                    consistent GTreasury branding.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Global search functionality with notifications and user
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Collapsible navigation for mobile devices with hamburger
                    menu integration.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Fixed header that stays visible during scrolling with
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>GTreasury design system</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Fully integrated with GTreasury color tokens and design
                    system.
                  </p>
                </CardContent>
              </Card>
          ...
          <section>
            ...
            <Card>
              <CardHeader>
                <CardDescription>
                  This navigation header is ready to use in your GTreasury
                  applications
                </CardDescription>
              </CardHeader>
              <CardContent>
